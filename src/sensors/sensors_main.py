...
from src.sensors.sensors_stores import LaunchStore, sondeStore
...
def scheduleYourSensors(scheduler):  # pragma: no cover
    ...
    addSchedule(scheduler, sondeWarehouse, timeToRun=now + timedelta(milliseconds=1000 * 120), second=every)
